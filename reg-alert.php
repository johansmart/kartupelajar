    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        <div class="alert alert-warning" role="alert">
            ...
            <strong>Permintaan Akun!</strong> Berhasil dikirim, selanjutnya anda akan menerima email tentang akun dan password anda dari system.  klik <a href="index.php"><strong><i>disini</i></strong></a> untuk login.
        </div>
      </div>
    </div>
  </div>
