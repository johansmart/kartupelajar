        ...
        <div class='col-md-12'>
          <div class='box box-info'>
            <div class='box-header with-border'>
              <h3 class='box-title'><i class='fa fa-edit'></i> Form Input Stempel Kartu</h3>
            </div>
            <?php
              $k=mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM stempel"));
            ?>
            <form class='form-horizontal' role='form' method=POST action='aksi/desain/ubah_stempel.php' enctype='multipart/form-data'><br>
              ...
              <div class='form-group'>
                <label class='col-sm-3 control-label'>Ganti Stempel :</label>
                <div class='col-sm-6'>
