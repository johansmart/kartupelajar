        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-print"></i> Cetak Kartu Perpustakaan</h3>
            </div>
            <!-- /.box-header -->
                  ...
                  <table id="example1" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center"><a target="blank" class='btn btn-success btn-lg' data-toggle='tooltip' title='Print Kartu' href='aksi/cetak/perpus.php?id=<?php echo $rr["id_session"];?>'><span class='fa fa-print'></span></a></td>
                      <?php  $no++; } ?>
                      </tr>
                    </tbody>
                  </table>
