        ...
        <div class='col-md-12'>
          <div class='box box-info'>
            <div class='box-header with-border'>
              <h3 class='box-title'><i class='fa fa-edit'></i> Form Upload Data Pelajar</h3>
            </div>
            <form class='form-horizontal' role='form' method=POST action='aksi/pelajar/unggah.php' enctype='multipart/form-data'>
              <div class='box-body'>
                <div class="alert alert-warning alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <h4><i class="icon fa fa-info-circle"></i> Informasi Penting</h4>
                  Untuk melakukan penggungahan data pelajar melalui file excel, harap mengikuti petunjuk berikut:
                  <div class="box-body">
                    <ol>
