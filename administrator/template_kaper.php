  ...
  <div class='content-wrapper'>
    ...
    <section class='content-header'>
      ...
      <ol class='breadcrumb'>
        ...
        <li class='active'>Template Kartu</li>
      </ol>
    </section>
        ...
        <div class='col-md-12'>
          <div class='box box-info'>
            <div class='box-header with-border'>
              <h3 class='box-title'><i class='fa fa-edit'></i> Form Input Template Kartu Perpustakaan</h3>
            </div>
            <?php
              $k=mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM tkaper"));
            ?>
            <form class='form-horizontal' role='form' method=POST action='aksi/desain/ubah_tkaper.php' enctype='multipart/form-data'><br>
              ...
              <div class='box-body'>
                <div class="alert bg-red alert-dismissible">
                  ...
                  <div class="box-body">
                    Untuk membuat template/desain kartu baru silahkan gunakanah ukuran (Width) 750 Pixel x (Height) 243 Pixel.
                  </div>
                </div>
              </div>
              <div class='form-group'>
                ...
                <div class='col-sm-6'>
                  <img class="img-responsive img-thumbnail" alt="Responsive image" src="../img/<?php echo "$k[gambar]";?>" width="300px"><br><?php echo "$k[gambar]";?>
                </div>
              </div>
              <div class='form-group'>
