        ...
        <div class='col-md-12'>
          <div class='box box-info'>
            <div class='box-header with-border'>
              <h3 class='box-title'><i class='fa fa-edit'></i> Form Input Template Kartu Pelajar</h3>
            </div>
            <?php
              $k=mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM tkapel"));
            ?>
            <form class='form-horizontal' role='form' method=POST action='aksi/desain/ubah_tkapel.php' enctype='multipart/form-data'><br>
