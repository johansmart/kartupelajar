        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-table"></i> Tabel Data Permintaan Akun Perusahaan</h3>
            </div>
            <!-- /.box-header -->
            <div class='table-responsive'>
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    <?php
                    $tampil = mysqli_query($koneksi, "SELECT * FROM permintaan_akun ORDER BY id DESC");
                    $no=1;
                    ...
                    <tr>
                      ...
                      <td>
                        <a class='btn btn-danger btn-xs' data-toggle='tooltip' title='Hapus Data' href='aksi/permintaan/hapus.php?id=<?php echo $r["id"];?>' onclick="return confirm('Apa anda yakin akan menghapus data ini?')"><span class='glyphicon glyphicon-remove'></span></a>
                      </td>
                    <?php  $no++; } ?>
                    </tr>
                  </tbody>
