<?php error_reporting(1);
    ...
    $tem=mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM tkaper WHERE id = '1'"));
?>
<!DOCTYPE html>
<html> <!-- Bagian halaman HTML yang akan konvert -->
<head>
    <meta charset='UTF-8'>
    <link rel="shortcut icon" href="../../../img/twh.png">
...
<div style="width: 750px;height: 243px;margin: 50px;background-image: url('../../../img/<?php echo "$tem[gambar]";?>');">
    ...
    <p style="position: absolute; font-family: arial; font-size: 10px; padding-left: 85px;text-transform: uppercase; text-align: center;"> Pemerintah Provinsi <?php echo $i["prov"];?><br>Kabupaten <?php echo $i["kab"];?><br>Dinas Pendidikan<br><b style="font-size: 12px"><?php echo $i["sekolah"];?></b></p>
    ...
    <img style="border: 1px solid #ffffff;position: absolute;margin-left: 20px;margin-top: -20px;" src="../../../img/<?php echo "$r[gambar]";?>" width="80px">
        ...
        <p style="margin-top: -200px;padding-left: 450px;padding-top: 10px;"><b>TATA TERTIB PERPUSTAKAAN SEKOLAH</b><br>
<ol style="padding-left: 400px;color: #FFFFFF; font-family: arial;font-size: 11px;text-align: justify;padding-right: 10px">
                      <li>Kartu ini diterbitkan oleh <?php echo "$i[sekolah]";?>, segala penggunaan kartu ini diatur oleh perpustakaan sesuai ketentuan dan syarat yang berlaku</a></li>
