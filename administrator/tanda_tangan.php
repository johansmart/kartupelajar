      ...
      <div class='row'>
        <div class='col-md-12'>
          <div class='box box-info'>
            ...
            <?php
              $k=mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM ttangan"));
            ?>
            <form class='form-horizontal' role='form' method=POST action='aksi/desain/ubah_tt.php' enctype='multipart/form-data'><br>
              ...
              <div class='form-group'>
                <label class='col-sm-3 control-label'>Ganti Tanda Tangan :</label>
                <div class='col-sm-6'>
